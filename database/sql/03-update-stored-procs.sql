...
declare @ownerId int = cast(json_value(@context, '$.UserId') as int)
...
/*
	POST
	Accepted Input: 
	Payload: '[{"title":"todo title", "completed": 0}, {"title": "another todo"}]'
    Context: '{"UserId": 0}' 0 = anonymous
*/
